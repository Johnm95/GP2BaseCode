...
public:
    ...
    int getNumberOfChildren(){
        return m_ChildGameObject.size();
    }
    
   void addChild(shared_ptr<GameObject> object){
       
       m_ChildGameObject.push_back(object);
    }
...
private:
    ...
    vector<shared_ptr<GameObject>> m_ChildGameObject;
};
